...
namespace Tyczkarze.Migrations
{
    ...
    [Migration("20191027190250_AllWithForegin5")]
    partial class AllWithForegin5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tyczkarze.Model.ExerciseParamDone", b =>
                {
                    ...
                    b.HasIndex("IdExerciseParamType");
            ...
            modelBuilder.Entity("Tyczkarze.Model.Jump", b =>
                {
                    ...
                    b.HasIndex("IdJumpStatus1");

                    b.HasIndex("IdJumpStatus2");

                    b.HasIndex("IdJumpStatus3");

                    b.HasIndex("IdJumpType");
            ...
            modelBuilder.Entity("Tyczkarze.Model.ExerciseDictTypeParam", b =>
                {
                    b.HasOne("Tyczkarze.Model.ExerciseParamType", "ExerciseParamType")
                        .WithMany("ExerciseDictTypeParams")
                        .HasForeignKey("IdExerciseParamType")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Tyczkarze.Model.ExerciseType", "ExerciseType")
                        .WithMany("ExerciseDictTypeParams")
            ...
            modelBuilder.Entity("Tyczkarze.Model.Jump", b =>
                {
                    ...
                    b.HasOne("Tyczkarze.Model.JumpStatus", "JumpStatus1")
                        .WithMany()
                        .HasForeignKey("IdJumpStatus1");

                    b.HasOne("Tyczkarze.Model.JumpStatus", "JumpStatus2")
                        .WithMany()
                        .HasForeignKey("IdJumpStatus2");

                    b.HasOne("Tyczkarze.Model.JumpStatus", "JumpStatus3")
                        .WithMany()
                        .HasForeignKey("IdJumpStatus3");

                    b.HasOne("Tyczkarze.Model.JumpType")
                        .WithMany("Jumps")
                        .HasForeignKey("IdJumpType")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Tyczkarze.Model.Pole", "Pole1")
                        .WithMany()
                        .HasForeignKey("IdPole1");

                    b.HasOne("Tyczkarze.Model.Pole", "Pole2")
                        .WithMany()
                        .HasForeignKey("IdPole2");

                    b.HasOne("Tyczkarze.Model.Pole", "Pole3")
                        .WithMany()
                        .HasForeignKey("IdPole3");
                });
